...
public class IsolatorAnteChamber {
	
	private Isolator isolator;
	private List<Filter> filters;
	private List<Portal> portals;
	
	public IsolatorAnteChamber() {
		super();
	}

	public IsolatorAnteChamber(Isolator isolator, List<Filter> filters, List<Portal> portals) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof IsolatorAnteChamber))
			return false;
		IsolatorAnteChamber other = (IsolatorAnteChamber) obj;
	...
	public String toString() {
		return "IsolatorAnteChamber [isolator=" + isolator + "]";
	}
